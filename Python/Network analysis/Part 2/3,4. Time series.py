...
import pandas as pd
data = pd.read_csv('uci_forum.csv')
import networkx as nx
import pandas as pd

data.index = pd.DatetimeIndex(data['date'])
data = data[['student', 'forum']]
...
#### MEAN DEGREE CENTRALITY DAY-BY-DAT ON STUDENTS PARTITION
from datetime import datetime, timedelta
import numpy as np
import networkx as nx
import matplotlib.pyplot as plt

# Get the students partition's nodes: forum_nodes
