...
#### CREATE DATAFRAME FROM LISTS OF FEATURE NAMES AND ROW LIST
# Define lists2dict()
...
#### PROCESS DATA IN CHUNK (1 BY 1) WITH GENERATOR
...
#### PROCESS DATA IN 1 CHUNK (MANY) WITH DATAFRAME
# Import the pandas package
import pandas as pd
...
#### PROCESS DATA IN MANY CHUNK (MANY) WITH DATAFRAME
# Define plot_pop()
